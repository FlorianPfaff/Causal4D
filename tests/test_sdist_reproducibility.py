...
_REQUIRED_PATHS = frozenset(
    {
        ...
        "examples/molmomotion_physics_bridge/export_molmo_forecast.py",
        "examples/molmomotion_physics_bridge/make_demo_input.py",
...
def test_extracted_sdist_runs_core_contract_tests(
    ...
    result = subprocess.run(
        [
            ...
            "tests/test_molmomotion_physics_bridge_example.py",
